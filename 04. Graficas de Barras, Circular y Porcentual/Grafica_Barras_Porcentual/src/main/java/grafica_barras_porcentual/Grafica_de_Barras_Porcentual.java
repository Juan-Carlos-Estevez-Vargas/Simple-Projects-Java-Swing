 ...
 */
package grafica_barras_porcentual;
 ...
 * @author User
 */
public class Grafica_de_Barras_Porcentual extends javax.swing.JFrame {

    /**
     * Creates new form Grafica_Circular
     */
    public Grafica_de_Barras_Porcentual() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Grafica_de_Barras_Porcentual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Grafica_de_Barras_Porcentual().setVisible(true);
            }
        });
    }
    ...
    public void paint(Graphics g) {
        ...
        if (bandera == true) {
            ...
            int total_valores = int_rojo + int_verde + int_azul;
            
            int largo_rojo = int_rojo * 350 / total_valores;
            int largo_verde = int_verde * 350 / total_valores;
            int largo_azul = int_azul * 350 / total_valores;
            
            int porcentaje_rojo = int_rojo * 100 / total_valores;
            int porcentaje_verde = int_verde * 100 / total_valores;
            int porcentaje_azul = int_azul * 100 / total_valores;
